...
import org.crownj.core.listeners.NewBestBlockListener;
...
public class BuildCheckpoints implements Callable<Integer> {
    ...
    public static void main(String[] args) throws Exception {
        BriefLogFormatter.initWithSilentcrownj();
    ...
    public Integer call() throws Exception {
        ...
        // Configure crownj to fetch only headers, not save them to disk, connect to a local fully synced/validated

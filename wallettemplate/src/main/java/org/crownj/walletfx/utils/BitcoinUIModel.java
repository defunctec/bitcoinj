...
package org.crownj.walletfx.utils;
...
/**
 * A class that exposes relevant crown stuff as JavaFX bindable properties.
 */
public class crownUIModel {
    ...
    public crownUIModel(Wallet wallet) {
        setWallet(wallet);
    }

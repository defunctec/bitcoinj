...
package org.crownj.walletfx.application;
...
import org.crownj.utils.AppDataDirectory;
...
public abstract class WalletApplication implements AppDelegate {
    ...
    protected void startWalletAppKit(Stage primaryStage) throws IOException {
        // Tell crownj to run event handlers on the JavaFX UI thread. This keeps things simple and means
    ...
    public void setupWalletKit(@Nullable DeterministicSeed seed) {
        ...
        walletAppKit = new WalletAppKit(params, preferredOutputScriptType, null, appDataDirectory, walletFileName) {
            ...
            protected void onSetupCompleted() {
                Platform.runLater(controller::oncrownSetup);
            }
        };
        // Now configure and start the appkit. This will take a second or two - we could show a temporary splash screen
        // or progress widget to keep the user engaged whilst we initialise, but we don't.
        if (params == RegTestParams.get()) {
            walletAppKit.connectToLocalHost();   // You should run a regtest mode crownd locally.
        }

...
# Change this to point to where you have a copy of the crownj.jar
sys.path.append(r"/path/to/crownj-core-0.12-bundled.jar")
...
if __name__ == "__main__":
    params = org.crownj.params.TestNet3Params.get()

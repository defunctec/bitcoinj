...
import static org.crownj.script.ScriptOpCodes.getOpCodeName;
import org.crownj.signers.LocalTransactionSigner;
import org.crownj.signers.TransactionSigner.ProposedTransaction;
...
public class GenerateLowSTests {
    ...
    public static void main(final String[] argv)
        ...
        final TransactionSignature signature = TransactionSignature.decodeFromcrown(scriptSig.getChunks().get(0).data, true, false);
        ...
        input.setScriptSig(new ScriptBuilder().data(highSig.encodeTocrown()).data(scriptSig.getChunks().get(1).data).build());
        input.getScriptSig().correctlySpends(outputTransaction, 0, null, null, output.getScriptPubKey(),

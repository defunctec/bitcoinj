...
public class ForwardingService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (params == RegTestParams.get()) {
            ...
            // If you pick this mode, you're expected to be running a local "crownd -regtest" instance.
        ...
        kit.wallet().addCoinsReceivedEventListener((w, tx, prevBalance, newBalance) -> {
            // Runs in the dedicated "user thread" (see crownj docs for more info on this).
            //

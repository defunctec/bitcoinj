...
public class SendRequest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // The Coin class represents a monetary crown value.
        ...
        // The Address class represents a crown address.
        ...
        // Have a look at the code of the SendRequest class to see what's happening and what other options you have: https://crownj.github.io/javadoc/0.11/com/google/crown/core/Wallet.SendRequest.html
        // 
        ...
        try {
            ...
            // crownj allows you to define a BalanceFuture to execute a callback once your wallet has a certain balance.
            // Here we wait until the we have enough balance and display a notice.
            // crownj is using the ListenableFutures of the Guava library. Have a look here for more information: https://github.com/google/guava/wiki/ListenableFutureExplained

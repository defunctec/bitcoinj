...
// This file shows how to use crownj from Javascript.
// To run, grab the crownj bundled JAR and then do something like this:
//
//   jjs -cp crownj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp crownj-0.12-bundled.jar
//
...
//
//   jjs -cp crownj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And crownj is a threaded library. This means you

...
import org.crownj.script.Script.VerifyFlag;
...
import static org.crownj.core.Transaction.SERIALIZE_TRANSACTION_NO_WITNESS;
import static org.crownj.core.Utils.HEX;
import static org.crownj.script.ScriptOpCodes.OP_0;
import static org.crownj.script.ScriptOpCodes.OP_INVALIDOPCODE;
...
public class ScriptTest {
    ...
    public void createAndUpdateEmptyInputScript() throws Exception {
        ...
        assertThat(inputScript.getChunks().get(0).data, equalTo(dummySig.encodeTocrown()));
        ...
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeTocrown()));
        assertThat(inputScript.getChunks().get(2).data, equalTo(dummySig.encodeTocrown()));
        ...
        inputScript = ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeTocrown(), 0, 1, 1);
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeTocrown()));
        assertThat(inputScript.getChunks().get(2).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(3).data, equalTo(multisigScript.getProgram()));

        inputScript = ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeTocrown(), 1, 1, 1);
        assertThat(inputScript.getChunks().get(0).opcode, equalTo(OP_0));
        assertThat(inputScript.getChunks().get(1).data, equalTo(dummySig.encodeTocrown()));
        assertThat(inputScript.getChunks().get(2).data, equalTo(dummySig.encodeTocrown()));
        assertThat(inputScript.getChunks().get(3).data, equalTo(multisigScript.getProgram()));
        ...
        try {
            ScriptBuilder.updateScriptWithSignature(inputScript, dummySig.encodeTocrown(), 1, 1, 1);
    ...
    public void dataDrivenInvalidTransactions() throws Exception {
        ...
        for (JsonNode test : json) {
            ...
            // crown Core checks this case in CheckTransaction, but we leave it to

...
import org.crownj.core.MessageSerializer;
import org.crownj.core.NetworkParameters;
import org.crownj.core.ProtocolException;
...
public class FakeTxBuilder {
    ...
    /**
     * Transaction[0] is a feeder transaction, supplying CRW to Transaction[1]
     */
    public static Transaction[] createFakeTx(NetworkParameters params, Coin value,
                                             Address to, Address from) {
        // Create fake TXes of sufficient realism to exercise the unit tests. This transaction send CRW from the
    ...
    public static DoubleSpends createFakeDoubleSpendTxns(NetworkParameters params, Address to) {
        ...
        try {
            doubleSpends.t1 = params.getDefaultSerializer().makeTransaction(doubleSpends.t1.crownSerialize());
            doubleSpends.t2 = params.getDefaultSerializer().makeTransaction(doubleSpends.t2.crownSerialize());

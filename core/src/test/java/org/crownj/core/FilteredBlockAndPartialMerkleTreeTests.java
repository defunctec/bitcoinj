...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    private static final crownSerializer SERIALIZER = new crownSerializer(UNITTEST, true);
    ...
    public void deserializeFilteredBlock() throws Exception {
        ...
        assertEquals(block, new FilteredBlock(UNITTEST, block.crownSerialize()));
    }
    ...
    public void serializeDownloadBlockWithWallet() throws Exception {
        ...
        // Note that all serialized forms here are generated by crown Core/pulled from block explorer
        ...
        assertArrayEquals(HEX.decode("0e1b091ca195e45a9164889b6bc46a09000000efbeadde02"), filter.unsafecrownSerialize());
    ...
    public void parseHugeDeclaredSizePartialMerkleTree() throws Exception{
        ...
        PartialMerkleTree pmt = new PartialMerkleTree(UNITTEST, bits, hashes, 3) {
            public void crownSerializeToStream(OutputStream stream) throws IOException {
        ...
        byte[] serializedPmt = pmt.crownSerialize();
        try {

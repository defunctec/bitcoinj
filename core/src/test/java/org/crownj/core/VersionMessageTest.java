...
public class VersionMessageTest {
    ...
    public void decode_noRelay_bestHeight_subVer() throws Exception {
        ...
        assertEquals("/crownj:0.13/", ver.subVer);
    }
    ...
    public void roundTrip_ipv4() throws Exception {
        ...
        ver.time = 23456;
        ver.subVer = "/crownj/";
        ver.clientVersion = NetworkParameters.ProtocolVersion.CURRENT.getcrownProtocolVersion();
        ver.localServices = 1;
        ...
        byte[] serialized = ver.crownSerialize();
        VersionMessage ver2 = new VersionMessage(UNITTEST, serialized);
        assertEquals(1234, ver2.bestHeight);
        assertEquals(23456, ver2.time);
        assertEquals("/crownj/", ver2.subVer);
        assertEquals(NetworkParameters.ProtocolVersion.CURRENT.getcrownProtocolVersion(), ver2.clientVersion);

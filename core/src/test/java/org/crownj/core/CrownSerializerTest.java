...
public class crownSerializerTest {
    ...
    public void testAddr() throws Exception {
        ...
        // the actual data from https://en.crown.it/wiki/Protocol_specification#addr
    ...
    public void testcrownPacketHeaderTooShort() {
        new crownSerializer.crownPacketHeader(ByteBuffer.wrap(new byte[] { 0 }));
    }

    @Test(expected = ProtocolException.class)
    public void testcrownPacketHeaderTooLong() {
        ...
        new crownSerializer.crownPacketHeader(ByteBuffer.wrap(wrongMessageLength));
    }

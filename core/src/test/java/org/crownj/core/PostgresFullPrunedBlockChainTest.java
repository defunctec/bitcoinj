...
import org.crownj.store.PostgresFullPrunedBlockStore;
...
public class PostgresFullPrunedBlockChainTest extends AbstractFullPrunedBlockChainTest
{
    ...
    // You can set up a fresh postgres with the command: create user crownj superuser password 'password';
    private static final String DB_HOSTNAME = "localhost";
    private static final String DB_NAME = "crownj_test";
    private static final String DB_USERNAME = "crownj";

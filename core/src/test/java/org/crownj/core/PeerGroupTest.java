...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void noPings() throws Exception {
        ...
        versionMessage.clientVersion = NetworkParameters.ProtocolVersion.BLOOM_FILTER.getcrownProtocolVersion();
    ...
    public void downloadPeerSelection() throws Exception {
        ...
        v1.clientVersion = NetworkParameters.ProtocolVersion.WITNESS_VERSION.getcrownProtocolVersion();
        ...
        v2.clientVersion = NetworkParameters.ProtocolVersion.WITNESS_VERSION.getcrownProtocolVersion();
    ...
    public void testBloomOnP2PK() throws Exception {
        ...
        assertTrue(p3.lastReceivedFilter.contains(outpoint.unsafecrownSerialize()));
    }
    ...
    public void preferLocalPeer() throws IOException {
        // Because we are using the same port (8333 or 18333) that is used by crown Core
    ...
    public void autoRescanOnKeyExhaustion() throws Exception {
        ...
        BloomFilter filter = new BloomFilter(UNITTEST, p1.lastReceivedFilter.crownSerialize());

...
import static org.crownj.core.Coin.CENT;
import static org.crownj.core.Coin.COIN;
import static org.crownj.core.Coin.SATOSHI;
import static org.crownj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.CRW.noCode();
    ...
    @Test
    public void mCRWRounding() throws Exception {
    ...
    @Test
    public void uCRWRounding() throws Exception {
    ...
    public void standardCodes() throws Exception {
        assertEquals("CRW 0.00", MonetaryFormat.CRW.format(Coin.ZERO).toString());
        assertEquals("mCRW 0.00", MonetaryFormat.MCRW.format(Coin.ZERO).toString());
        assertEquals("µCRW 0", MonetaryFormat.UCRW.format(Coin.ZERO).toString());
        assertEquals("sat 0", MonetaryFormat.SAT.format(Coin.ZERO).toString());
    }

    @Test
    public void standardSymbol() throws Exception {
        assertEquals(MonetaryFormat.SYMBOL_CRW + " 0.00", new MonetaryFormat(true).format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dCRW 0", MonetaryFormat.UCRW.code(1, "dCRW").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        assertEquals("0", MonetaryFormat.UCRW.noCode().shift(0).format(Coin.ZERO).toString());
        // Ensure that inserting a code after codes are wiped, works
        assertEquals("dCRW 0", MonetaryFormat.UCRW.noCode().code(1, "dCRW").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("CRW 0.00", MonetaryFormat.CRW.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 CRW", MonetaryFormat.CRW.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("CRW@0.00", MonetaryFormat.CRW.codeSeparator('@').format(Coin.ZERO).toString());
    }

    @Test(expected = NumberFormatException.class)
    public void missingCode() throws Exception {
        MonetaryFormat.UCRW.shift(1).format(Coin.ZERO);
    }
    ...
    public void parse() throws Exception {
        ...
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MCRW.parse("1"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MCRW.parse("1.0"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MCRW.parse("01.0000000000"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MCRW.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MCRW.parse("-1"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MCRW.parse("-1.0"));

        assertEquals(Coin.MICROCOIN, MonetaryFormat.UCRW.parse("1"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UCRW.parse("1.0"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UCRW.parse("01.0000000000"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UCRW.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UCRW.parse("-1"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UCRW.parse("-1.0"));

...
import org.crownj.params.Networks;
import org.crownj.script.Script.ScriptType;

/**
 * <p>A crown address looks like 1MsScoe2fTJoq4ZPdQgqyhgWeoNamYPevy and is derived from an elliptic curve public key
...
public class LegacyAddress extends Address {
    ...
    /** The (big endian) 20 byte hash that is the core of a crown address. */
    @Override
    public byte[] getHash() {
        return bytes;
    }

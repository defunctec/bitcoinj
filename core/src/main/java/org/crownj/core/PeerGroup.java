...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * the FP rate higher, due to <a href="https://groups.google.com/forum/#!msg/crownj/Ys13qkTwcNg/9qxnhwnkeoIJ">
     * various complexities</a> there are still ways a remote peer can deanonymize the users wallet. This is why the
     * FP rate is chosen for performance rather than privacy. If a future version of crownj fixes the known
     ...
     * <a href="https://github.com/crown/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     *
    ...
    /**
     * When true (the default), PeerGroup will attempt to connect to a crown node running on localhost before
     * attempting to use the P2P network. If successful, only localhost will be used. This makes for a simple
     * and easy way for a user to upgrade a crownj based app running in SPV mode to fully validating security.
     */

...
import org.crownj.net.discovery.*;
...
import org.crownj.utils.VersionTally;

/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a crown chain.</p>
 *
...
public abstract class NetworkParameters {
    ...
    public static final String ID_MAINNET = "org.crown.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.crown.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.crown.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.crownj.unittest";
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all crown implementations. For a
     ...
     * test and main crown networks use 2 weeks (1209600 seconds).
     */
    ...
    /** How many blocks pass between difficulty adjustment periods. crown standardises this to be 2016. */
    ...
    /**
     * Scheme part for URIs, for example "crown".
     */
    public abstract String getUriScheme();

    /**
     * Returns whether this network has a maximum number of coins (finite supply) or
     * not. Always returns true for crown, but exists to be overridden for other
     * networks.
     */
     ...
     */
    public abstract crownSerializer getSerializer(boolean parseRetain);
    ...
    public static enum ProtocolVersion {
        ...
        private final int crownProtocol;

        ProtocolVersion(final int crownProtocol) {
            this.crownProtocol = crownProtocol;
        }

        public int getcrownProtocolVersion() {
            return crownProtocol;
        }
    }
}

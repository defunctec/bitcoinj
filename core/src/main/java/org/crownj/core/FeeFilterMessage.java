 ...
 *
 * <p>See <a href="https://github.com/crown/bips/blob/master/bip-0133.mediawiki">BIP133</a> for details.</p>
 *
...
public class FeeFilterMessage extends Message {
    ...
    public FeeFilterMessage(NetworkParameters params, byte[] payloadBytes, crownSerializer serializer, int length) {
    ...
    protected void crownSerializeToStream(OutputStream stream) throws IOException {
        super.crownSerializeToStream(stream);

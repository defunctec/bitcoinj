...
public class VersionMessage extends Message {
    ...
    public static final String crownj_VERSION = "0.17-SNAPSHOT";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/crownj:" + crownj_VERSION + "/";
    ...
    /** A service bit used by crown-ABC to announce crown Cash nodes. */
    public static final int NODE_crown_CASH = 1 << 5;
    ...
    /**
     * User-Agent as defined in <a href="https://github.com/crown/bips/blob/master/bip-0014.mediawiki">BIP 14</a>.
     * crown Core sets it to something like "/Satoshi:0.9.1/".
     */
     ...
     * See <a href="https://github.com/crown/bips/blob/master/bip-0037.mediawiki#extensions-to-existing-messages">BIP 37</a>.
     */
    ...
    public VersionMessage(NetworkParameters params, int newBestHeight) {
        ...
        // Note that the crown Core doesn't do anything with these, and finding out your own external IP address
    ...
    @Override
    public void crownSerializeToStream(OutputStream buf) throws IOException {
        ...
        receivingAddr.crownSerializeToStream(buf);
        fromAddr.crownSerializeToStream(buf);
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for crownj
     * users might look like "/crownj:0.13/MultiBit:1.2/" where libraries come further to the left.</p>
     *
     ...
     * set of "/crownj:1.0/MultiBit:1.0(Windows)/". Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.</p>
     *
     * <p>See <a href="https://github.com/crown/bips/blob/master/bip-0014.mediawiki">BIP 14</a> for more information.</p>
     *

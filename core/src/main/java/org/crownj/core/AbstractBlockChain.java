 ...
 * crown Core. To learn more about the alternative security models, please consult the articles on the
 * website.</p>
 *
 * <b>Theory</b>
 *
...
public abstract class AbstractBlockChain {
     ...
     *
     * Following this one down to the genesis block produces the story of the economy from the creation of crown
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            // article here for more details: https://crownj.github.io/security-model
            try {
                block.verifyHeader();
    ...
    private static void sendTransactionsToListener(StoredBlock block, NewBlockType blockType,
        ...
        for (Transaction tx : transactions) {
            try {
                ...
                if (clone)
                    tx = tx.params.getDefaultSerializer().makeTransaction(tx.crownSerialize());

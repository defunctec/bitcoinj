 ...
 * Currently this includes getaddr, verack and special crownj class UnknownMessage.</p>
 * 
...
public abstract class EmptyMessage extends Message {
    ...
    @Override
    protected final void crownSerializeToStream(OutputStream stream) throws IOException {
    }

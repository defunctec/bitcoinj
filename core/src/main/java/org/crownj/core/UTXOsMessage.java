 ...
 * supported by crown Core. An implementation is available in <a href="https://github.com/crownxt/crownxt">crown XT</a>,
 ...
 *
 * <p>The getutxos/utxos protocol is defined in <a href="https://github.com/crown/bips/blob/master/bip-0065.mediawiki">BIP 65</a>.
...
public class UTXOsMessage extends Message {
    ...
    protected void crownSerializeToStream(OutputStream stream) throws IOException {
        ...
        for (int i = 0; i < outputs.size(); i++) {
            ...
            output.crownSerializeToStream(stream);
        }
    }

...
public abstract class MessageSerializer {
     ...
     */
    public abstract crownSerializer.crownPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException, UnsupportedOperationException;

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link crownSerializer#deserializeHeader}.
     */
    public abstract Message deserializePayload(crownSerializer.crownPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException, UnsupportedOperationException;

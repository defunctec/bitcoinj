...
import org.crownj.net.MessageWriteTarget;
 ...
 * {@code org.crownj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
    ...
    private crownSerializer.crownPacketHeader header;
    ...
    public int receiveBytes(ByteBuffer buff) {
        checkArgument(buff.position() == 0 &&
                buff.capacity() >= crownSerializer.crownPacketHeader.HEADER_LENGTH + 4);
        try {

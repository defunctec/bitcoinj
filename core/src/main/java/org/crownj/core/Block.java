...
import static org.crownj.core.Sha256Hash.*;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the crown system.
 ...
 * <a href="http://www.crown.org/crown.pdf">the crown technical paper</a> for
...
public class Block extends Message {
    ...
    static final long ALLOWED_TIME_DRIFT = 2 * 60 * 60; // Same value as crown Core.

    /**
     * A constant shared by the entire network: how large in bytes a block is allowed to be. One day we may have to
     * upgrade everyone to change this, so crown can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Standard maximum value for difficultyTarget (nBits) (crown MainNet and TestNet) */
    ...
    /**
     * Construct a block object from the crown wire format.
    ...
    /**
     * Construct a block object from the crown wire format. Used in the case of a block
     * contained within another message (i.e. for AuxPoW header).
     *
     * @param params NetworkParameters object.
     * @param payloadBytes crown protocol formatted byte array containing message content.
     * @param offset The location of the first payload byte within the array.
    ...
    /** @deprecated Use {@link AbstractcrownNetParams#getBlockInflation(int)} */
    @Deprecated
    public Coin getBlockInflation(int height) {
        return ((AbstractcrownNetParams) params).getBlockInflation(height);
    }
     ...
     * Useful for non-crown chains where the block header may not be a fixed
     * size.
     */
    ...
    public int getOptimalEncodingMessageSize() {
        ...
        optimalEncodingMessageSize = crownSerialize().length;
        return optimalEncodingMessageSize;
    }
    ...
    /** Returns the version of the block data structure as defined by the crown protocol. */
     ...
     * the difficulty value reported by the crown "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, Coin value, final int height) {
        ...
        coinbase.length = coinbase.unsafecrownSerialize().length;
    ...
    /**
     * Create a block sending 50CRW as a coinbase transaction to the public key specified.
     ...
     * <a href="https://github.com/crown/bips/blob/master/bip-0034.mediawiki">BIP34: Height in Coinbase</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/crown/bips/blob/master/bip-0066.mediawiki">BIP66: Strict DER signatures</a>.
     */
    ...
    /**
     * Returns whether this block conforms to
     * <a href="https://github.com/crown/bips/blob/master/bip-0065.mediawiki">BIP65: OP_CHECKLOCKTIMEVERIFY</a>.
     */

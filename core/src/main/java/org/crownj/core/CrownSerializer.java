...
/**
 * <p>Methods to serialize and de-serialize messages to the crown network format as defined in
 * <a href="https://en.crown.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.crownSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class crownSerializer extends MessageSerializer {
    private static final Logger log = LoggerFactory.getLogger(crownSerializer.class);
    ...
    /**
     * Constructs a crownSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and determining packetMagic
     * @param parseRetain      retain the backing byte array of a message for fast reserialization.
     */
    public crownSerializer(NetworkParameters params, boolean parseRetain) {
     ...
     * @param parseRetain      retain the backing byte array of a message for fast reserialization.
     */
    public crownSerializer(NetworkParameters params, int protocolVersion, boolean parseRetain) {
        this.params = params;
    ...
    @Override
    public crownSerializer withProtocolVersion(int protocolVersion) {
        return protocolVersion == this.protocolVersion ?
                this : new crownSerializer(params, protocolVersion, parseRetain);
    }
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("crownSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.crownSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A crown protocol message has the following format.
        //
        ...
        //
        // crown Core ignores garbage before the magic header bytes. We have to do the same because
        // sometimes it sends us stuff that isn't part of any message.
        seekPastMagicBytes(in);
        crownPacketHeader header = new crownPacketHeader(in);
     ...
     */
    @Override
    public crownPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new crownPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link crownSerializer#deserializeHeader}.
     */
    @Override
    public Message deserializePayload(crownPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class crownPacketHeader {
        ...
        public crownPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof crownSerializer)) return false;
        crownSerializer other = (crownSerializer) o;

...
/**
 * A collection of various utility methods that are helpful for working with the crown protocol.
 * To enable debug logging from the library, run with -Dcrownj.logging=true on your command line.
 */
public class Utils {
     ...
     * forces crownj to try to allocate a huge piece of the memory resulting in OutOfMemoryError.
    */
     ...
     *
     * <p>crown only uses this "compact" format for encoding difficulty targets, which are unsigned 256bit quantities.

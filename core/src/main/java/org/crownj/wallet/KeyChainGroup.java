...
public class KeyChainGroup implements KeyBag {
    ...
    public static class Builder {
         ...
         * chain. This behaviour will likely be changed with crownj 0.16 such that only a P2WPKH chain is created and
         * activated.</p>
     ...
     * @see org.crownj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.crownj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.crownj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */

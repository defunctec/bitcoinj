 ...
 * <a href="https://github.com/crown/bips/blob/master/bip-0032.mediawiki">BIP 32 standard</a>, as implemented by
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from crownj users, but I've heard of cases via the grapevine of
            ...
            if (t == Protos.Key.Type.DETERMINISTIC_MNEMONIC) {
                ...
                if (!isWatchingAccountKey) {
                    ...
                    if (path.isEmpty()) {
                        ...
                        // (also known as change addresses). https://github.com/crown/bips/blob/master/bip-0044.mediawiki

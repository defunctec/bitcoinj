...
import org.crown.protocols.payments.Protos.PaymentDetails;
...
import org.crownj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * is how mining is incentivized in later years of the crown system when inflation drops. It also provides
     ...
     * when choosing which transactions to add to a block. Note that, to keep this equivalent to crown Core
    ...
    /**
     * <p>Requires that there be enough fee for a default crown Core to at least relay the transaction.

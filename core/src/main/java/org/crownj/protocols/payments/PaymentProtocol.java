...
import org.crownj.crypto.X509Utils;
...
/**
 * <p>Utility methods and constants for working with <a href="https://github.com/crown/bips/blob/master/bip-0070.mediawiki">
 ...
 * protocol data does not flow over the crown P2P network or enter the block chain. It's instead for data that is only
 * of interest to the parties involved but isn't otherwise needed for consensus.</p>
 */
public class PaymentProtocol {

    // MIME types as defined in BIP71.
    public static final String MIMETYPE_PAYMENTREQUEST = "application/crown-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/crown-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/crown-paymentack";
    ...
    public static Protos.Payment createPaymentMessage(List<Transaction> transactions,
        ...
        for (Transaction transaction : transactions) {
            transaction.verify();
            builder.addTransactions(ByteString.copyFrom(transaction.unsafecrownSerialize()));
        }

...
/**
 * Implementation of the <a href="https://github.com/crown/bips/blob/master/bip-0032.mediawiki">BIP 32</a>
...
public final class HDKeyDerivation {
    ...
    public static DeterministicKey createMasterPrivateKey(byte[] seed) throws HDDerivationException {
        ...
        // Calculate I = HMAC-SHA512(key="crown seed", msg=S)
        byte[] i = HDUtils.hmacSha512(HDUtils.createHmacSha512Digest("crown seed".getBytes()), seed);

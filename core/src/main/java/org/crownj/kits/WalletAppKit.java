...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV crownj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit crownj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing crownj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the crownj website
     * (https://crownj.github.io/speeding-up-chain-sync) for further details.
     */
    ...
    protected void startUp() throws Exception {
        ...
        try {
            ...
            // Initiate crown network objects (block store, blockchain and peer group)

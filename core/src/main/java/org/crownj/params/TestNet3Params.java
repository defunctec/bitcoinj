...
import org.crownj.net.discovery.HttpDiscovery;
...
/**
 * Parameters for the testnet, a separate public instance of crown that has relaxed rules suitable for development
 * and testing of applications and new crown versions.
 */
public class TestNet3Params extends AbstractcrownNetParams {
    ...
    public TestNet3Params() {
        ...
        dnsSeeds = new String[] {
                "testnet-seed.crown.jonasschnelli.ch", // Jonas Schnelli
                "seed.tCRW.petertodd.org",               // Peter Todd
                "seed.testnet.crown.sprovoost.nl",     // Sjors Provoost
        ...
        httpSeeds = new HttpDiscovery.Details[] {
                ...
                new HttpDiscovery.Details(
                        ...
                        URI.create("http://testnet.httpseed.crown.schildbach.de/peers")
                )
        };
        addrSeeds = null;
    ...
    public void checkDifficultyTransitions(final StoredBlock storedPrev, final Block nextBlock,
        ...
        if (!isDifficultyTransitionPoint(storedPrev.getHeight()) && nextBlock.getTime().after(testnetDiffDate)) {
            ...
            // There is an integer underflow bug in crown-qt that means mindiff blocks are accepted when time
            // goes backwards.

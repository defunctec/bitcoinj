...
import org.crownj.core.crownSerializer;

/**
 * Parameters for crown-like networks.
 */
public abstract class AbstractcrownNetParams extends NetworkParameters {

    /**
     * Scheme part for crown URIs.
     */
    public static final String crown_SCHEME = "crown";
    public static final int REWARD_HALVING_INTERVAL = 210000;

    private static final Logger log = LoggerFactory.getLogger(AbstractcrownNetParams.class);

    /** lazy-initialized by the first call to {@link NetworkParameters#getGenesisBlock()} */
    protected Block genesisBlock;

    public AbstractcrownNetParams() {
        super();
        interval = INTERVAL;
    ...
    /**
     * <p>A utility method that calculates how much new crown would be created by the block at the given height.
     * The inflation of crown is predictable and drops roughly every 4 years (210,000 blocks). At the dawn of
    ...
    public int getProtocolVersionNum(final ProtocolVersion version) {
        return version.getcrownProtocolVersion();
    }

    @Override
    public crownSerializer getSerializer(boolean parseRetain) {
        return new crownSerializer(this, parseRetain);
    }

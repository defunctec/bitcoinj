 ...
 */
public class MainNetParams extends AbstractcrownNetParams {
    ...
    public MainNetParams() {
        ...
        dnsSeeds = new String[] {
                "seed.crown.sipa.be",         // Pieter Wuille
                "dnsseed.bluematt.me",          // Matt Corallo
                "dnsseed.crown.dashjr.org",   // Luke Dashjr
                "seed.crownstats.com",        // Chris Decker
                "seed.crown.jonasschnelli.ch",// Jonas Schnelli
                "seed.CRW.petertodd.org",       // Peter Todd
                "seed.crown.sprovoost.nl",    // Sjors Provoost
        ...
        httpSeeds = new HttpDiscovery.Details[] {
                ...
                new HttpDiscovery.Details(
                        ...
                        URI.create("http://httpseed.crown.schildbach.de/peers")
                ),
                // Anton Kumaigorodski
                new HttpDiscovery.Details(

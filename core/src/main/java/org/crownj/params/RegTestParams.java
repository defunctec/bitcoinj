...
/**
 * Network parameters for the regression test mode of crownd in which all blocks are trivially solvable.
 */
public class RegTestParams extends AbstractcrownNetParams {

 ...
 * This class is based on the conventions used in crown Core which
 * uses the following locations:
 * <dl>
 *     <dt>Windows</dt><dd>{@code ${APPDATA}/.crown}</dd>
 *     <dt>macOS</dt><dd>{@code ${HOME}/Library/Application Support/crown}</dd>
 *     <dt>Linux</dt><dd>{@code ${HOME}/.crown}</dd>
 * </dl>

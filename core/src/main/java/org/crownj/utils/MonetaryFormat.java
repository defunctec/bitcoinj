...
import org.crownj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /** Standard format for the CRW denomination. */
    public static final MonetaryFormat CRW = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mCRW denomination. */
    public static final MonetaryFormat MCRW = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µCRW denomination. */
    public static final MonetaryFormat UCRW = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    ...
    /** Currency code for base 1 crown. */
    public static final String CODE_CRW = "CRW";
    /** Currency code for base 1/1000 crown. */
    public static final String CODE_MCRW = "mCRW";
    /** Currency code for base 1/1000000 crown. */
    public static final String CODE_UCRW = "µCRW";
    /** Currency code for base 1 satoshi. */
    public static final String CODE_SAT = "sat";
    /** Currency symbol for base 1 crown. */
    public static final String SYMBOL_CRW = "\u20bf";
    /** Currency symbol for base 1/1000 crown. */
    public static final String SYMBOL_MCRW = "m" + SYMBOL_CRW;
    /** Currency symbol for base 1/1000000 crown. */
    public static final String SYMBOL_UCRW = "µ" + SYMBOL_CRW;
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for crown
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard CRW notation that was
     ...
     * Construct a MonetaryFormat with the default configuration.
     *
     * @param useSymbol use unicode symbols instead of the CRW and sat codes
     */
    public MonetaryFormat(boolean useSymbol) {
        ...
        this.codes[0] = useSymbol ? SYMBOL_CRW : CODE_CRW;
        this.codes[3] = useSymbol ? SYMBOL_MCRW : CODE_MCRW;
        this.codes[6] = useSymbol ? SYMBOL_UCRW : CODE_UCRW;

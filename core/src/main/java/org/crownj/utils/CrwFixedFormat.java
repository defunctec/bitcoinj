...
import static org.crownj.core.Coin.SMALLEST_UNIT_EXPONENT;
...
/**
 * <p>This class, a concrete extension of {@link CRWFormat}, is distinguished in that each
 * instance formats and by-default parses all crown monetary values in units of a single
 ...
 * custom pattern using either the {@link CRWFormat.Builder#localizedPattern} or
 * {@link CRWFormat.Builder#localizedPattern} methods, as described in the documentation for
 * the {@link CRWFormat.Builder} class.</p>
 *
 * <p>A more detailed explanation, including examples, is in the documentation for the
 * {@link CRWFormat} class, and further information beyond that is in the documentation for the
...
public final class CRWFixedFormat extends CRWFormat {
     ...
     *  the same value expressed in crowns. */
    private final int scale;

    /** Constructor */
    protected CRWFixedFormat(
     ...
     * the denomination is millicrowns, this method will return the value {@code 3}.  As
     ...
     *  the denomination is millicrowns, this method will return the value {@code 3}.  */
    @Override
     ...
     * denomination is millicrowns, then this method will return {@code "mCRW"},
     * assuming the default base currency-code is not overridden using a
     * {@link CRWFormat.Builder}.  */
     ...
     * millicrowns, this method by default returns {@code "₥฿"}, depending on the
     * locale.  */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof CRWFixedFormat)) return false;
        CRWFixedFormat other = (CRWFixedFormat)o;

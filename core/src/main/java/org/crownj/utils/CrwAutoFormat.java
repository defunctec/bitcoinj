...
/**
 * <p>This class, a concrete extension of {@link CRWFormat}, is distinguished by its
 * accommodation of multiple denominational units as follows:
 *
 * <p>When formatting crown monetary values, an instance of this class automatically adjusts
 ...
 *
 * <p>When parsing {@code String} representations of crown monetary values, instances of
 ...
 * CRWFormat} class, and further information beyond that is in the documentation for the {@link
 ...
 * @see          org.crownj.core.Coin
 */

public final class CRWAutoFormat extends CRWFormat {
    ...
    public enum Style {
        ...
        /** Constant for the formatting style that uses a currency code, e.g., "CRW". */
        CODE {
    ...
    /** Constructor */
    protected CRWAutoFormat(Locale locale, Style style, int fractionPlaces) {
    ...
    /**
     * Calculate the appropriate denomination for the given crown monetary value.  This
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof CRWAutoFormat)) return false;
